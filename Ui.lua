...
local redzlib = {
	Themes = {
		-- 🌑 Aesthetic Dark — deep void black com accent roxo/lilás neon
		Darker = {
			["Color Hub 1"] = ColorSequence.new({
				ColorSequenceKeypoint.new(0.00, Color3.fromRGB(10, 10, 15)),
				ColorSequenceKeypoint.new(0.40, Color3.fromRGB(14, 13, 22)),
				ColorSequenceKeypoint.new(1.00, Color3.fromRGB(10, 10, 15))
			}),
			["Color Hub 2"] = Color3.fromRGB(16, 15, 24),
			["Color Stroke"] = Color3.fromRGB(38, 34, 58),
			["Color Theme"] = Color3.fromRGB(138, 99, 255),
			["Color Text"] = Color3.fromRGB(235, 232, 255),
			["Color Dark Text"] = Color3.fromRGB(148, 138, 190)
		},
		-- 🌌 Midnight Rose — dark navy com accent rosa/magenta
		Dark = {
			["Color Hub 1"] = ColorSequence.new({
				ColorSequenceKeypoint.new(0.00, Color3.fromRGB(12, 10, 18)),
				ColorSequenceKeypoint.new(0.45, Color3.fromRGB(18, 14, 28)),
				ColorSequenceKeypoint.new(1.00, Color3.fromRGB(12, 10, 18))
			}),
			["Color Hub 2"] = Color3.fromRGB(20, 16, 30),
			["Color Stroke"] = Color3.fromRGB(50, 32, 65),
			["Color Theme"] = Color3.fromRGB(220, 80, 180),
			["Color Text"] = Color3.fromRGB(245, 230, 255),
			["Color Dark Text"] = Color3.fromRGB(175, 148, 205)
		},
		-- 💎 Abyss Cyan — dark preto-azulado com accent ciano/teal neon
		Purple = {
			["Color Hub 1"] = ColorSequence.new({
				ColorSequenceKeypoint.new(0.00, Color3.fromRGB(8, 12, 18)),
				ColorSequenceKeypoint.new(0.45, Color3.fromRGB(11, 16, 26)),
				ColorSequenceKeypoint.new(1.00, Color3.fromRGB(8, 12, 18))
			}),
			["Color Hub 2"] = Color3.fromRGB(13, 17, 27),
			["Color Stroke"] = Color3.fromRGB(24, 42, 65),
			["Color Theme"] = Color3.fromRGB(0, 210, 200),
			["Color Text"] = Color3.fromRGB(220, 240, 255),
			["Color Dark Text"] = Color3.fromRGB(130, 175, 210)
		}
	},
	Info = {
		Version = "1.1.0"
...
AddEle("Button", function(parent, props, ...)
	...
	New.MouseEnter:Connect(function()
		New.BackgroundTransparency = 0.35
	end)
...
local function ButtonFrame(Instance, Title, Description, HolderSize)
	...
	local Frame = Make("Button", Instance, {
		...
		AutomaticSize = "Y",
		Name = "Option"
	})Make("Corner", Frame, UDim.new(0, 8))Make("Stroke", Frame)
...
function redzlib:MakeWindow(Configs)
	...
	-- Aesthetic separator line under TopBar
	local TopBarSeparator = InsertTheme(Create("Frame", MainFrame, {
	...
	local function ControlSize()
		...
		TopBarSeparator.Size = UDim2.new(1, -20, 0, 1)
	end
	...
	function Window:MinimizeBtn()
		...
		if Minimized then
			...
			CreateTween({MainFrame, "Size", UDim2.fromOffset(MainFrame.Size.X.Offset, 34), 0.25, true})
			Minimized = true
		end
	...
	function Window:Dialog(Configs)
		...
		})Make("Gradient", Frame, {Rotation = 270})Make("Corner", Frame)Make("Stroke", Frame)
	...
	function Window:MakeTab(paste, Configs)
		...
		local TabSelect = Make("Button", MainScroll, {
			Size = UDim2.new(1, 0, 0, 28)
		})Make("Corner", TabSelect)Make("Stroke", TabSelect)
		
		local LabelTitle = InsertTheme(Create("TextLabel", TabSelect, {
			Size = UDim2.new(1, TIcon and -28 or -16, 1),
			Position = UDim2.fromOffset(TIcon and 28 or 16),
			BackgroundTransparency = 1,
			Font = Enum.Font.GothamBold,
			Text = TName,
			TextColor3 = Theme["Color Text"],
		...
		function Tab:Disable()
			...
			CreateTween({LabelTitle, "TextTransparency", 0.35, 0.3})
			CreateTween({LabelIcon, "ImageTransparency", 0.35, 0.3})
		...
		function Tab:AddToggle(Configs)
			...
			local ToggleHolder = InsertTheme(Create("Frame", Button, {
				...
				AnchorPoint = Vector2.new(1, 0.5),
				BackgroundColor3 = Theme["Color Stroke"]
			}), "Stroke")Make("Corner", ToggleHolder, UDim.new(0.5, 0))Make("Stroke", ToggleHolder)
			...
			local function SetToggle(Val)
				...
				if Default then
					...
					CreateTween({Toggle, "BackgroundTransparency", 0.5, 0.25})
		...
		function Tab:AddDiscordInvite(Configs)
			...
			local JoinButton = Create("TextButton", FrameHolder, {
				...
				BackgroundColor3 = Color3.fromRGB(88, 60, 200)
			})Make("Corner", JoinButton, UDim.new(0, 6))Make("Stroke", JoinButton)
			...
			JoinButton.Activated:Connect(function()
				...
				SetProps(JoinButton, {
					Text = "Copied!",
					BackgroundColor3 = Color3.fromRGB(40, 36, 70),
					TextColor3 = Color3.fromRGB(138, 99, 255)
				})task.wait(5)
				SetProps(JoinButton, {
					Text = "Join Server",
					BackgroundColor3 = Color3.fromRGB(88, 60, 200),
